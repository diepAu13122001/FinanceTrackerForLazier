    ...
    return (
        <div className="relative">
            ...
            <button
                ...
                className={`
                    ${DS.inputBase} flex items-center justify-between cursor-pointer mt-1
            ...
            >
                {selected ? (
                    <div className="flex items-center gap-2">
                        ...
                        {/* NORMAL wallet: hiện số dư */}
                        {selected.type === 'NORMAL' && (
                            <span className="text-xs text-text-muted">
                                {formatVND(selected.balance)}
                            </span>
                        )}
                    </div>
                ) : (
            ...
            {open && (
                <>
                    ...
                    <div className="absolute z-40 mt-1 w-full bg-white rounded-xl shadow-xl border border-surface-border max-h-72 overflow-y-auto">
                        ...
                        {isLoading && (
                            <div className="px-3 py-4 text-sm text-text-muted">Đang tải...</div>
                        )}
                        ...
                        {!isLoading && (!wallets || wallets.length === 0) && (
                            <div className="px-3 py-4 text-center">
                                ...
                                <button
                                    onClick={() => { navigate('/goals'); setOpen(false) }}
